...
class BikePolicy
{
    ...
    {
        return $user->isOwner($bike) || $user->hasRole(['editor', 'administrador', 'todopoderoso']);
    }
    ...
    {
        return $user->isOwner($bike) || $user->hasRole(['administrador', 'todopoderoso']);
    }
    ...
    {
        #  True si el ususario es el propietario o tiene uno de los roles
        return $user->isOwner($bike) || $user->hasRole(['administrador', 'todopoderoso']);
    }
